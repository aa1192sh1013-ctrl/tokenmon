 ...
 * 초반은 빠르게 터지고(Lv.2 = 800만 토큰) 후반은 길게 가는 앞쏠림 곡선,
 * 만렙 누적 5,700 XP ≈ 총 57억 토큰.
 */
export const LEVEL_XP: readonly number[] = [
  0, 0, 8, 18, 32, 52, 80, 120, 175, 250, 350, 480, 650, 880, 1_200, 1_650, 2_250, 3_000, 3_900, 4_800, 5_700,
];
